...
// ///new
// const String apiUrl = 'http://piiprent.piipai.com/';
...
const String googleApiKey = 'AIzaSyDeFSk9weEIo9tdJWrDqGfh6abmYYEo2OY';
...
Map<int, String> TimesheetStatus = {
  0: "timesheet.status.new",
  1: "timesheet.status.pre_shift_check_pending",
  2: "timesheet.status.pre_shift_check_confirmed",
  3: "timesheet.status.pre_shift_check_failed",
  4: "timesheet.status.submit_pending",
  5: "timesheet.status.approval_pending",
  6: "timesheet.status.supervisor_modified",
  7: "timesheet.status.approved",
};
...
Color hintColor = Color(0xffD3DEEA);
Color greyColor = Color(0xFF888888);
Color activeTextColor = Color(0xff000000);
Color whiteColor = Color(0xffffffff);
Color lightBlue = Color(0xffEEF6FF);
Color successColor = Color(0xff66BA6C);
Color warningColor = Colors.red.shade600;

List<Map<String, dynamic>> countries = countries = [
  {
